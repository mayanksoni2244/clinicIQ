 ...
 const ContactPage = () => {
   return (
     <div className="max-w-4xl mx-auto mt-12 px-4">
       <h1 className="text-4xl font-bold text-blue-700 text-center mb-8">How You Can Contact Us</h1>
       <p className="text-center text-gray-700 mb-12">
         नीचे दिये गए तरीकों से आप <span className="font-semibold">ClinicIQ</span> से संपर्क कर सकते हैं।
       </p>
